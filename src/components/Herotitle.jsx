...
const Herotitle = () => {
  return (
    <div className="h-[200px]   flex flex-col items-center  justify-center text-center px-6 ">
      ...
      <h1 className="text-4xl font-apex md:text-6xl font-semibold text-gray-800">
        Discover & Share
      </h1>

      {/* Second Line: Sell Artworks */}
      <h1 className="text-4xl font-apex md:text-6xl font-extrabold text-gray-800 mt-2">
        Sell Artworks
      </h1>

      {/* Third Line: Description */}
      <p className="mt-4  font-roboto text-sm md:text-lg font-light text-gray-600 max-w-2xl mx-auto">
