      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {nfts.map((nft) => (
            <div
              key={nft.id}
              className="bg-white rounded-lg shadow-lg overflow-hidden hover:scale-105 transform transition duration-300 w-[270px] h-[392px] relative border border-gray-200"
            >
              ...
              <div className="relative group">
                <img
                  src={nft.image}
                  alt={nft.title}
                  className="w-[292px] h-[314px] rounded-md object-cover"
                />
