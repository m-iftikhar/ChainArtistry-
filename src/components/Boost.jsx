      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
        ...
        <div className="text-white flex flex-col justify-center">
          ...
          <div className="flex justify-start">
            <button className="inline-flex items-center font-apex px-4 w-[120px] py-2 bg-red-600 text-white text-sm hover:bg-red-400">
        ...
        <div className="relative flex justify-center items-center  md:flex">
          ...
          <div className="absolute top-0 left-[-20px] md:left-[-40px] transform">
            <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4 border-b border-gray-300 flex items-center space-x-2">
                <img src={proflie} alt="Icon" className="w-8 h-8 opacity-60" /> {/* Reduced opacity */}
              ...
              <img
                src={boost}
                alt="NFT 1"
                className="w-32 md:w-48 h-auto bg-red-600"
              />
              {/* Overlay: Buttons */}
          ...
          <div className="absolute top-16 right-[-20px] md:right-[-40px] transform">
            <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <img
                src={boost}
                alt="NFT 2"
                className="w-32 md:w-48 h-auto bg-red-500"
              />
              {/* Overlay: Buttons */}
              <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent text-white px-4 py-2 flex justify-between items-center rounded-b-lg">
          ...
          <div className="absolute bottom-[-40px] md:bottom-[-80px] left-[-20px] md:left-[-40px] transform">
            <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
              {/* White space for icon and name */}
              <div className="p-4 border-b border-gray-300 flex items-center space-x-2">
                <img src={proflie} alt="Icon" className="w-8 h-8 opacity-100" /> {/* Full opacity */}
                <span className="text-black font-apex">Stella Nova</span>
              </div>
              ...
              <img
                src={boost}
                alt="NFT 3"
                className="w-32 md:w-48 h-28 opacity-90 bg-red-300"
              />
              {/* Overlay: Buttons */}
              <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent text-white px-4 py-2 flex justify-between items-center rounded-b-lg">
