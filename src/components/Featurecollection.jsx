...
const Featurecollection = () => {
  ...
  return (
    <div className="py-10 px-5 w-full h-[589.88px] mt-[50px]">
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center md:justify-start space-x-0 md:space-x-4 overflow-hidden">
          {cards.slice(currentIndex, currentIndex + cardsPerSlide).map((card) => (
            <div
              key={card.id}
              className="relative w-[308px] h-[411px] md:w-[270px] mx-2 mb-4 md:mb-0 p-4 bg-white rounded-lg shadow-lg transition-all duration-500 ease-in-out transform scale-100"
            >
              {/* Profile Section at the Top */}
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-10 h-10 bg-gray-300 rounded-[23.52px] left-[-2442px] border-[0.78px] flex items-center justify-center text-gray-700 font-bold">
