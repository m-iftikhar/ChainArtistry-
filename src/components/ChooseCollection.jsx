  ...
  return (
    <div className="flex justify-center items-center min-h-[150vh] bg-gradient-to-b from-pink-100 to-pink-200">
      ...
      <div className="relative flex flex-col items-center bg-white shadow-lg w-full  max-w-[1164px] h-[730px] p-6 rounded-lg">
        ...
        <Link to="/mintdata">
          <button className="absolute left-6 top-6 bg-red-500 text-white w-[100px] h-[50px] rounded-md font-medium">
            Back
          </button>
        </Link>
        ...
        <button className="absolute bottom-6 right-6 px-6 py-2 bg-red-500 font-roboto text-white rounded-md font-medium">
          Next
        </button>
      </div>
    </div>
