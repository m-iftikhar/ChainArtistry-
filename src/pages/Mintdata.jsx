...
const Mintdata = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center mt-[100px] items-start p-4 sm:p-6 md:p-8 gap-6 sm:gap-8 bg-gradient-to-b from-pink-50 to-pink-200 min-h-screen">
